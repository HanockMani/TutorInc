...
class checkboxlist{
	...
	{
		echo'
			<div class="divp35"><input type="checkbox" name="sub_list[]" value="Malayalam"><span>Malayalam</span></div>
	...
	{
		echo '
			<div class="divp35"><input type="checkbox" name="medium_list[]" value="Malayalam"><span>Malayalam</span></div>
