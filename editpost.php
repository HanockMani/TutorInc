...
<div>
	<div>
		...
		<a class="navlink" href="index.php" style="margin: 0px 0px 0px 100px;">Home </a>

			<a class="navlink" href="index.php">Newsfeed</a>
				...
				?>
			  	...
			  	<div class="itemrow">
			  			...
			  			<div style="width: 80%; float: left;">
			  				<div class="divp35"><input <?php $sub1=strstr($sub, "Malayalam"); if($sub1 != '') echo 'checked'; ?> type="checkbox" name="sub_list[]" value="Malayalam"><span>Malayalam</span></div>
					...
					<div class="itemrow">
				  	...
				  	<div class="itemrow">
				  			...
				  			<div style="width: 80%; float: left;">
								<div class="divp35"><input <?php $medium1=strstr($medium, "Malayalam"); if($medium1 != '') echo 'checked'; ?> type="checkbox" name="medium_list[]" value="Malayalam"><span>Malayalam</span></div>
								<div class="divp35"><input <?php $medium1=strstr($medium, "Hindi"); if($medium1 != '') echo 'checked'; ?> type="checkbox" name="medium_list[]" value="Hindi"><span>Hindi</span></div>
