...
<div>
		...
		<div class="w3-sidebar w3-bar-block w3-collapse w3-card-2 w3-animate-left" >
		</div>
		<div class="topnav">
			<div class="parent2">
        ...
        <a class="navlink" href="Admin/index.php" >Admin </a>
			...
			<?php
				...
				if(isset($success_message)) {echo $success_message;}
				    ...
				    <div class="accounttype">
				      <input type="radio" value="teacher" id="radioOne" name="account" >
				      <label for="radioOne" class="radio" chec>As a Teacher</label>
				      <input type="radio" value="student" id="radioTwo" name="account" checked/>
